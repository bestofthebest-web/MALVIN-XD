...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "malvin~A3NDkQSC#WMLwE5YGPdaic3HKTUTlCfFme_g-UO8PefAuZPV51sI",
...
// make true if you want auto reply on status 
        ...
        AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || "*SEEN YOUR STATUS BY Ray White😆*",
...
// add img for alive msg
        ...
        LIVE_MSG: process.env.LIVE_MSG || "> 🙂 *© Ray White :* Die Peasant ",
// add alive msg here 
...
// add bot owner name
              ...
              DESCRIPTION: process.env.DESCRIPTION || " *© Ray Whiteヅ*",
// add bot owner name    
...
START_MSG: process.env.START_MSG || ` Thanks for adding me to the group you lik piece of sh¡t👋🏻* 
